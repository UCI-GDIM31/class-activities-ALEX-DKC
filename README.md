...
2, 
float _speed — lets you set the bat’s movement speed in the Inspector.
Transform _playerTransform — stores the player’s location so the bat knows what to chase.

The BatW6 class needs both a Unity-provided method (Update()) and two custom methods (EnableChase() and DisableChase()).
